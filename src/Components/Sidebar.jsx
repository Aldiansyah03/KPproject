import { FaBoxes, FaUsers, FaTools, FaSignOutAlt, FaHome } from "react-icons/fa"; // Import FaHome untuk ikon Home
        ...
        >
          ...
          <ul className="text-white font-semibold">
            ...
            <li className="mb-2 rounded hover:bg-blue-500 py-2 px-3">
              <Link to="/home" onClick={onClose} className="flex items-center">
